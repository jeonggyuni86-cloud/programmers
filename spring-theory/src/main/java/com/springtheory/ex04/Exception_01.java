...
// 그리고 아무것도 하지 않고, 별 문제 없는 것처럼 넘어가 버리는 건 정말 위험한 일이다.
// 프로그램 실행 중에 어디선가 예외가 발생했는데, 그것을 무시히고 계속 진행하기 때문이다.
...
public class Exception_01 {
    ...
    void 무책임한throws() throws SQLException {
        method3();
    }
