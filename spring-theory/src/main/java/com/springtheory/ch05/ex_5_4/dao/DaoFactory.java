...
import com.springtheory.ch05.ex_5_4.service.*;
...
public class DaoFactory {
    ...
    @Bean
    public UserService userService() {return new UserServiceImpl(userDAO(), mailSender());}

    @Bean
    public UserServiceImpl userServiceImpl() {return new UserServiceImpl(userDAO(), mailSender());}
