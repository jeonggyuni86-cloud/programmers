...
// - UserDAO : DB에 어떻게 넣고 빼는가(데이터 접근)을 책임진다.
// - 레벨 업드레이드 조건 / 순서 같은 '업무 규칙(비즈니스 로직)'은 데이터 접근과 성격이 다르다.
