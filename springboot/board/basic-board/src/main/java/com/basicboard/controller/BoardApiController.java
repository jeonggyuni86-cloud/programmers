...
public class BoardApiController {
    ...
    public ResponseEntity<Resource> downloadFile(
        ...
        // filename* 는 인코딩을 명시하는 최신 문법으로, "저장될 기본 파일명"을 정한다.
        // 이게 없으면 URL끝의 UUID 붙은 이름으로 저장돼 버린다. 그래서 원본 이름으로 저장하게 되는 것
        // UTF-8 뒤에 '' 안에는 언어 지정핼 수 있으나, 이경우 생략 (ex UTF-8'ko')
        //
    ...
    // (Page를 그대로 응답하면 스프링이 구조적 안정성에 대한 경고를 낼 수 있다.)
