...
// - 그래서 "직접 구현한 메서드"는 이 별도 인터페이스에 선언하고, 실제 코드는 BoardRepositoryImpl에 짠다.
...
// - BoardRepositoryCustom의 이름은 BoardRepositoryImpl 로 맞춰야 스프링이 자동으로 연결한다.
// - BoardRepositoryCustomImpl이 아닌 BoardRepositoryImpl이다.
// - 붙이는 기준은 "메인 레포지토리 이름"
public interface BoardRepositoryCustom {
    Page<BoardListItemResponseDto> searchBoards(
